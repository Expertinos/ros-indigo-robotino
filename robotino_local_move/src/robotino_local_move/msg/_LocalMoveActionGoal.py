...
class LocalMoveActionGoal(genpy.Message):
  _md5sum = "68a36fa3b32a4bc7c7deca214daf5836"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3fB.pack(_x.goal.move_x, _x.goal.move_y, _x.goal.rotation, _x.goal.movementType))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.move_x, _x.goal.move_y, _x.goal.rotation, _x.goal.movementType,) = _struct_3fB.unpack(str[start:end])
      return self
