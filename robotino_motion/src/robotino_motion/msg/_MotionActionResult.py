"""autogenerated by genpy from robotino_motion/MotionActionResult.msg. Do not edit."""
import sys
...
class MotionActionResult(genpy.Message):
  _md5sum = "52c534d56beb86ba57b81eeaa1ae9845"
  _type = "robotino_motion/MotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robotino_motion/MotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robotino_motion.msg.MotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robotino_motion.msg.MotionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.result.extra_info, _x.result.achieved_goal))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.extra_info, _x.result.achieved_goal,) = _struct_2B.unpack(str[start:end])
      self.result.achieved_goal = bool(self.result.achieved_goal)
      return self
