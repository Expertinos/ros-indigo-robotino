"""autogenerated by genpy from robotino_motion/MotionActionFeedback.msg. Do not edit."""
import sys
...
class MotionActionFeedback(genpy.Message):
  _md5sum = "fa55ab92daa83914e90389f8cb88a8f6"
  _type = "robotino_motion/MotionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robotino_motion/MotionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = robotino_motion.msg.MotionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robotino_motion.msg.MotionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4fB2f.pack(_x.feedback.percentage, _x.feedback.state.d_x, _x.feedback.state.d_y, _x.feedback.state.d_phi, _x.feedback.state.loaded, _x.feedback.elapsed_time, _x.feedback.expected_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.percentage, _x.feedback.state.d_x, _x.feedback.state.d_y, _x.feedback.state.d_phi, _x.feedback.state.loaded, _x.feedback.elapsed_time, _x.feedback.expected_time,) = _struct_4fB2f.unpack(str[start:end])
      self.feedback.state.loaded = bool(self.feedback.state.loaded)
      return self
